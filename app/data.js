...
export const PICKS = {
  Edel: [
    ...
    P("Tyler Bilodeau","UCLA",7,10.5,"F",20,2),
    P("Terry Anderson","High Point",12,8.2,"G",18,3),
    P("Latrell Wrightsell","Alabama",4,11.5,"G",22,4),
  ],
  Iger: [
    ...
    P("Dailyn Swain","Texas",11,11.0,"G",22,3),
    P("Dame Sarr","Duke",1,9.4,"F",18,2),
    P("Tomislav Ivisic","Illinois",3,11.2,"C",22,1),
  ],
  Feder: [
    ...
    P("Carson Cooper","Michigan State",3,7.8,"C",14,0),
  ...
  Warren: [
    ...
    P("Oscar Cluff","Purdue",2,8.4,"G",16,2),
    P("Dominique Daniels","Cal Baptist",13,23.2,"G",47,7),
    P("Mikey Lewis","Saint Mary's",10,14.5,"G",24,3),
  ],
  Spathis: [
    ...
    P("Paulius Murauskas","Saint Mary's",10,8.8,"F",18,2),
    P("Patrick Ngongba","Duke",1,10.7,"F",20,1),
    P("Izaiyah Nelson","South Florida",11,16.2,"F",22,0),
  ],
  Glover: [
  ...
  Jeff: [
    ...
    P("Bryce Hopkins","St. John's",5,14.2,"F",26,2),
    P("Nate Ament","Tennessee",6,16.4,"F",28,1),
    P("Wes Enis","South Florida",11,12.8,"G",19,4),
  ...
  Clay: [
    ...
    P("David Mirkovic","Illinois",3,8.5,"F",16,2),
    P("Ivan Kharchenkov","Arizona",1,9.8,"F",18,1),
    P("Milos Uzan","Houston",2,11.5,"G",20,2),
    P("Malik Reneau","Miami FL",7,10.8,"F",22,1),
    P("Chris Cenac Jr","Houston",2,7.2,"F",14,1),
    P("Boopie Miller","SMU",11,18.2,"G",28,5),
  ],
  Sack: [
    ...
    P("Rienk Mast","Nebraska",4,9.6,"F",18,1),
    P("Trevon Brazile","Arkansas",4,7.8,"F",16,1),
    P("Jaron Pierre Jr","SMU",11,14.5,"G",25,5),
  ],
  Stein: [
    ...
    P("Meleek Thomas","Arkansas",4,12.8,"G",28,5),
    P("John Blackwell","Wisconsin",5,18.3,"G",32,4),
    P("Terrence Hill Jr","VCU",11,12.4,"G",24,4),
